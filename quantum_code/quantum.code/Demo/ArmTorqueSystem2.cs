...
namespace Quantum
{
    public unsafe class ArmTorqueSystem2 : SystemMainThreadFilter<ArmTorqueSystem2.Filter>, ISignalOnPlayerDataSet
    {
        ...
        public struct Filter
        {
            ...
            public ArmComponent2* Arm;

        }

        public override void Update(Frame f, ref Filter filter)
        {
            var input = f.GetPlayerInput(1);
