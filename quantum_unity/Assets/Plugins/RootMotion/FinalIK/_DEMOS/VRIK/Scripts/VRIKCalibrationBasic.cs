        ...
        private void LateUpdate()
        {
            ...
            * */
            if (Input.GetKeyDown(KeyCode.D))
            {
                ...
                {
                    Debug.LogError(
                        "No Calibration Data to calibrate to, please calibrate with 'C' first."
                    );
                }
                else
                {
            ...
            if (Input.GetKeyDown(KeyCode.S))
            {
                ...
                {
                    Debug.LogError(
                        "Avatar needs to be calibrated before RecalibrateScale is called."
                    );
                }
